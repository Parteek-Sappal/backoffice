<%@ Page Title="" Language="C#" MasterPageFile="~/office/layouts/BackMaster.Master" AutoEventWireup="true" CodeBehind="productcategory.aspx.cs" Inherits="backoffice.office.Products.productcategory" Theme="backtheme" %>
       ...
       <table id="TABLE1" border="0" cellpadding="1" cellspacing="0" style="width: 100%">
        <tr>
            <td align="left" colspan="2">
                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                    <tr>
                        <td class="head1">
                            Add/Edit Product Series
                        </td>
                        <td align="right">
                            &nbsp;
                            <asp:TextBox ID="seriesid" runat="server" Visible="False" Width="33px"></asp:TextBox>
        ...
        <tr>
            ...
            <td align="left" width="85%" height="26px">
                ...
                <asp:TextBox ID="longdetails" runat="server" Visible="False" Width="122px"></asp:TextBox>
            </td>
        </tr>
        ...
        <tr >
            ...
            <td align="left">
                <asp:Image ID="imgbanner" runat="server" Visible="False" Height="100" Width="100" />
            </td>
        </tr>

        <tr style="display:none">
            <td align="right">
                Upload Mobile Img<span class="star">*</span> :&nbsp;
            </td>
            <td align="left">
                <input id="File3" runat="server" class="box" contenteditable="false" onchange="showpreview(this);"
                    type="file" />&nbsp;<asp:Label ID="Label5" runat="server" Text="(Image should be of size : 288x209.)"
                        ForeColor="red" Font-Italic="true" Visible="false"></asp:Label>
                <br />
                <asp:Label ID="Label6" runat="server" Text="(Image show on homepage should be of size : 500 x 511.)"
                    ForeColor="red" Font-Italic="true" Visible="false"></asp:Label>
                <asp:LinkButton ID="LinkButton3" runat="server" CssClass="toptxt" 
                    Visible="false" onclick="LinkButton3_Click"
                    >Remove Image</asp:LinkButton>
                <asp:TextBox ID="mobilebanner" runat="server" Visible="False" Width="122px">
                </asp:TextBox>
            </td>
        </tr>
        ...
        <tr>
            <td align="right">
                Upload Icon<span class="star"></span> :&nbsp;
            </td>
            <td align="left">
                <input id="File4" runat="server" class="box" contenteditable="false" onchange="showpreview(this);"
                    type="file" />&nbsp;<asp:Label ID="Label7" runat="server" Text="(Image should be of size : 288x209.)"
                        ForeColor="red" Font-Italic="true" Visible="false"></asp:Label>
                <br />
                <asp:Label ID="Label8" runat="server" Text="(Image show on homepage should be of size : 500 x 511.)"
                    ForeColor="red" Font-Italic="true" Visible="false"></asp:Label>
                <asp:LinkButton ID="LinkButton4" runat="server" CssClass="toptxt" 
                    Visible="false" onclick="LinkButton4_Click" 
                    >Remove Image</asp:LinkButton>
                <asp:TextBox ID="mobileicon" runat="server" Visible="False" Width="122px">
                </asp:TextBox>
            </td>
        </tr>
         ...
         <tr >
            ...
            <td align="left">
                <asp:Image ID="Image3" runat="server" Visible="False" Height="100" Width="100" />
            </td>
        </tr>
