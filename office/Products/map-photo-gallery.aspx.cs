...
{
    public partial class map_photo_gallery : System.Web.UI.Page
    {
            ...
            foreach (DataListItem row1 in dl_sgroup.Items)
            {
                ...
                if ((checkfeature.Checked == true))
                {
                    ...
                    if (Conversion.Val(drpdept.SelectedValue) != 0)
                    {
                        ...
                        if (clsm.Checking("select malbumid from map_photo_gallery where collageid="
                                        ...
                                        + (Conversion.Val(drpdept.SelectedValue) + "")))))) == false)
                        {
                            ...
                            clsm.ExecuteQry("insert into map_photo_gallery (collageid,albumid,deptid,displayorder) values("
                        ...
                        else
                        {
                            ...
                            clsm.ExecuteQry("update  map_photo_gallery  set  displayorder=" + txtdisplayorder.Text + " where collageid=" + (Conversion.Val(Request.QueryString["clid"])) + " and albumid=" + Conversion.Val(lblEventsid.Text) + " and deptid=" + Conversion.Val(drpdept.SelectedValue) + "");
                    ...
                    {
                        clsm.ExecuteQry("update  map_photo_gallery  set  showonhome=1 where collageid=" + (Conversion.Val(Request.QueryString["clid"])) + " and albumid=" + Conversion.Val(lblEventsid.Text) + " and deptid=" + Conversion.Val(drpdept.SelectedValue) + "");
                    }
                    else
                    {
                        clsm.ExecuteQry("update  map_photo_gallery  set  showonhome=0 where collageid=" + (Conversion.Val(Request.QueryString["clid"])) + " and albumid=" + Conversion.Val(lblEventsid.Text) + " and deptid=" + Conversion.Val(drpdept.SelectedValue) + "");
                    }
                ...
                else
                {
                    ...
                    clsm.ExecuteQry("delete from  map_photo_gallery where  collageid=" + Conversion.Val(Request.QueryString["clid"]) + " and albumid=" + Conversion.Val(lblEventsid.Text) + "  and deptid=" + Conversion.Val(drpdept.SelectedValue) + "  ");
