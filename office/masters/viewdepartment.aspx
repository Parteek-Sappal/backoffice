<%@ Page Title="" Language="C#" MasterPageFile="~/office/layouts/BackMaster.Master" AutoEventWireup="true" CodeBehind="viewdepartment.aspx.cs" Inherits="backoffice.office.masters.viewdepartment" Theme="backtheme" %>
                        ...
                        <asp:TemplateField HeaderText="Edit">
                            ...
                            <ItemTemplate>
                                <asp:ImageButton ID="btnedit" runat="server" CausesValidation="false" CommandArgument='<%#Eval("deptid")%>'
                                    CommandName="redit" ImageUrl="~/office/assets/edit.png" ToolTip="Click to Edit" />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
