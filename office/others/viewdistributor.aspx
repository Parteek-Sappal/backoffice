<%@ Page Title="" Language="C#" MasterPageFile="~/office/layouts/BackMaster.Master" AutoEventWireup="true" CodeBehind="viewdistributor.aspx.cs" Inherits="backoffice.office.others.viewdistributor" Theme="backtheme" %>
            ...
            <td align="center" colspan="2">
                <asp:GridView ID="GridView1" runat="server" Width="100%" AllowPaging="True" PageSize="50" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="category" HeaderText="Type" ItemStyle-Width="15%" Visible="true">
                            <ItemStyle Width="15%"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField="annualturnover" HeaderText="Annual Turnover" />
                        <asp:BoundField DataField="brands" HeaderText="Brands" Visible="false" />
                        ...
                        <asp:TemplateField HeaderText="Reply" Visible="false">
                            <ItemStyle Width="10%" />
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkreply" runat="server" CausesValidation="false" CommandArgument='<%# Eval("distid") %>'
                                    OnClick="lnkreply_Click"><img border="0" src="../../office/assets/Preview_24x24.png" alt="" /></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Delete">
                            <ItemStyle Width="5%" />
                            <ItemTemplate>
                                <asp:ImageButton ID="btndel" runat="server" CausesValidation="false" CommandArgument='<%# Eval("distid") %>'
                        ...
                        <asp:TemplateField HeaderText="Details" meta:resourcekey="TemplateFieldResource3" Visible="false">
                            ...
                            <ItemTemplate>
                                <a id='various<%# ((GridViewRow)Container).RowIndex + 1 %>' class="toptxt" visible="false"
                                    href='view-enquiry-details.aspx?&eid=<%#Eval("distid")%>'>
                                    <img border="0" width="25" height="25" src="../../office/assets/Preview_24x24.png"
                                        alt="" />
                                </a>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="View">
                            <ItemStyle Width="5%" />
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkdetail" runat="server" CausesValidation="false" CommandArgument='<%# Eval("distid") %>'
