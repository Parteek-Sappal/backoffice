<%@ Page Title="" Language="C#" MasterPageFile="~/office/layouts/BackMaster.Master" AutoEventWireup="true" CodeBehind="productenquiry.aspx.cs" Inherits="backoffice.office.others.productenquiry" %>
    ...
    <table id="TABLE1" cellpadding="2" cellspacing="0" width="100%">
                ...
                <asp:GridView ID="GridView1" runat="server" Width="100%" AllowPaging="True" PageSize="50" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="productcode" HeaderText="Product Code" />                     
                           ...
                           <asp:BoundField DataField="productname" HeaderText="Product Name" ItemStyle-Width="15%" Visible="true" />
                        <asp:BoundField DataField="size" HeaderText="Size"  />
                        <asp:BoundField DataField="look" HeaderText="Look"  />
                        <asp:BoundField DataField="coat" HeaderText="Coat" />
                        <asp:BoundField DataField="color" HeaderText="Color"  />
                        <asp:BoundField DataField="Model" HeaderText="Model"  />
                        <asp:BoundField DataField="typetitle" HeaderText="Type"  />
        ...
        <tr>
            <td colspan="2" align="center">
                <asp:Panel ID="Panel1" Height="350px" ScrollBars="Vertical" runat="server" CssClass="modalPopup"
                                ...
                                <table border="0" cellpadding="1" cellspacing="0" style="width: 70%">
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                        ...
                                        <td align="left" style="width: 70%" valign="top">
                                            <asp:Label ID="lblCoat" runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                     <tr>
                                        <td align="right" style="width: 30%" valign="top">
                                     ...
                                     <tr>
                                        ...
                                        <td align="left" style="width: 70%" valign="top">
                                            <asp:Label ID="lbllook" runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                      <tr>
                                        <td align="right" style="width: 30%" valign="top">
