<%@ Page Title="" Language="C#" MasterPageFile="~/office/layouts/BackMaster.Master" AutoEventWireup="true" CodeBehind="addpages.aspx.cs" Inherits="backoffice.office.cms.addpages" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  <script type="text/javascript">
    $(function () {
        CKEDITOR.replace('<%=megamenu.ClientID %>', { filebrowserImageUploadUrl: '/Upload.ashx' });
        CKEDITOR.replace('<%=smalldesc.ClientID %>', { filebrowserImageUploadUrl: '/Upload.ashx' });
        CKEDITOR.replace('<%=Pagedescription.ClientID %>', { filebrowserImageUploadUrl: '/Upload.ashx' });
    });
    </script>
 <h2>Add/Edit Page</h2>
    ...
    <table id="TABLE1" border="0" cellpadding="1" cellspacing="0" style="width: 100%">
     ...
     <tr>  <%--style="display:none"--%>
          ...
          <tr>
            ...
            <td align="left">                
                  <CKEditor:CKEditorControl ID="megamenu" runat="server" Height="250" BasePath="~/ckeditor">
        ...
        <tr>
            ...
            <td align="left">                
                <CKEditor:CKEditorControl ID="smalldesc" runat="server" Height="250" BasePath="~/ckeditor">
                </CKEditor:CKEditorControl>
            </td>
        </tr>
        <tr>
            ...
            <td align="left">                
                <CKEditor:CKEditorControl ID="Pagedescription" runat="server" Height="250" BasePath="~/ckeditor">
                </CKEditor:CKEditorControl>
            </td>
        </tr>
        ...
        <tr style="display:none">
            ...
            <td align="left">                
                <CKEditor:CKEditorControl ID="PageDescription1" runat="server" Height="250" BasePath="~/ckeditor">
                </CKEditor:CKEditorControl>
            </td>
        </tr>
          <tr style="display:none">
            ...
            <td align="left">                
                <CKEditor:CKEditorControl ID="PageDescription2" runat="server" Height="250" BasePath="~/ckeditor">
                </CKEditor:CKEditorControl>
            </td>
        </tr>
        ...
        <tr>
            <td class="head1" colspan="2" style="font-size: small;">
                SEO Information</td> 
        </tr>
         <tr style="display:none" >
            <td align="right">
        ...
        <tr style="display: none;">
            ...
            <td align="left">
                <asp:CheckBox ID="Pagestatus" runat="server" Checked="true" /></td>
        </tr>
        <tr style="display: none;">
            <td align="right">
                Quick Links :&nbsp;
        ...
        <tr>
            ...
            <td align="left">
                <asp:Button ID="btnSubmit" runat="server" Text="Submit" CssClass="btnbg" OnClick="submit" />
